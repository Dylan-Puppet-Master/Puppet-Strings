...
```skedge
REQUEST ANY_1_OF {staff.lucy + staff.tom} DO 'take out garbage' DURING ANY_1_OF blocks.all ON EACH_OF dates.season.mondays
```
...
```skedge
ANY_1_OF d IN dates.session.two.all
