...
2. Open the request manager (`puppet-strings app`), press **Load offerings**, then add or adjust requests acccording to the shared camp schedule request doc or personl requests from staff members. This is also where I would request that staff members be trained on clinics.
