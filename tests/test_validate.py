...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "REQUEST AT_LEAST 1 ANY staff.all NOT FREE WITHOUT staff.rob",
            Priority.HIGH,
            "FREE has no instance",
            1,
            43,
        ...
        (
            "REQUEST AT_LEAST 0 ANY staff.all DO 'x'",
            Priority.HIGH,
        ...
        (
            "PREFER AT_MOST 1 ANY staff.all DO 'x'",
        ...
        (
            "REQUEST AT_MOST 1 ANY staff.rob DO 'break'",
            Priority.HIGH,
            "is one item and takes no quantifier",
            1,
            19,
        ...
        (
            "REQUEST ANY staff.all DO 'x' DURING blocks.clinic_1",
            Priority.HIGH,
