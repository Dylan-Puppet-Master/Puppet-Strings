...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            f"{DO} ON {{dates.session.this.all - 1d}}",
            Priority.HIGH,
        ...
        (
            "REQUEST staff.dylan DO 'x' DURING ANY_1_OF blocks.all ON dates.session.this.week.nine.all",
            Priority.HIGH,
            "unknown name 'dates.session.this.week.nine.all'",
            1,
            58,
        ),
        (
